...
adata_mod1 <- anndata::read_h5ad("resources_test/predict_modality/pbmc_1k_protein_v3.mod1.h5ad")
adata_mod2 <- anndata::read_h5ad("resources_test/predict_modality/pbmc_1k_protein_v3.mod2.h5ad")
