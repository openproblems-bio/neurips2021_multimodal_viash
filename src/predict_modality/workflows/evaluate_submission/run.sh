...
#   --solutions 's3://neurips2021-multimodal-public-datasets/predict_modality/**.output_test_mod2.h5ad' \
...
NXF_VER=21.04.1 nextflow run \
  ...
  --publishDir /home/rcannood/Downloads/starter_kits/starter_kit-predict_modality-python/output/evaluation \
  -resume