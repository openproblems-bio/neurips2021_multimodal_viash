...
pearson_vec_1[!is.finite(pearson_vec_1)] <- 0
spearman_vec_1[!is.finite(spearman_vec_1)] <- 0
...
pearson_vec_2[!is.finite(pearson_vec_2)] <- 0
spearman_vec_2[!is.finite(spearman_vec_2)] <- 0
