...
write_tsv(df %>% gather(metric_id, value, -starts_with("dataset_"), -starts_with("method_")), "output/pilot/joint_embedding/scores.tsv")
```
...
write_tsv(summ, "output/pilot/joint_embedding/summary.tsv")
summ %>% 
