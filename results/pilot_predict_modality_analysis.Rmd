...
df <- 
  ...
  readr::read_tsv(
    "output/pilot/predict_modality/output.final_scores.output_scores.tsv",
...
ggplot(dfg %>% filter(metric_id %in% c("mean_spearman_per_cell", "mean_spearman_per_gene", "logp1_mse"))) + 
