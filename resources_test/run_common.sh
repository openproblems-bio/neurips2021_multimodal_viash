...
$target_dir/common_datasets/download_10x_dataset/download_10x_dataset \
  ...
  --output_rna ${out_file}.temp.output_rna.h5ad \
  --output_mod2 ${out_file}.temp.output_mod2.h5ad

$target_dir/common/quality_control/quality_control \
  --input_rna ${out_file}.temp.output_rna.h5ad \
  --input_mod2 ${out_file}.temp.output_mod2.h5ad \
  --output_rna ${out_file}.output_rna.h5ad \
  --output_mod2 ${out_file}.output_mod2.h5ad \
  --min_counts_per_gene 1000 \
  --min_counts_per_cell 1000

rm ${out_file}.temp.output_rna.h5ad ${out_file}.temp.output_mod2.h5ad
